...
export class RateLimit extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RateLimit {
        return new RateLimit(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:getambassador.io/v1beta1:RateLimit';
    ...
    public readonly apiVersion!: pulumi.Output<"getambassador.io/v1beta1" | undefined>;
    public readonly kind!: pulumi.Output<"RateLimit" | undefined>;
    ...
    constructor(name: string, args?: RateLimitArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["apiVersion"] = "getambassador.io/v1beta1";
            resourceInputs["kind"] = "RateLimit";
...
export interface RateLimitArgs {
    apiVersion?: pulumi.Input<"getambassador.io/v1beta1">;
    kind?: pulumi.Input<"RateLimit">;
